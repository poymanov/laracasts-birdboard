...
<template>
    <div>
        <div v-if="$page.props.flash.success && show" class="mb-8 bg-green-500">
            <div class="w-100 mx-auto sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show" class="mb-8 bg-red-500">
            <div class="w-100 mx-auto sm:px-6 lg:px-8 flex items-center justify-between">
                <div class="flex items-center">
